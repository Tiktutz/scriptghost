...
<body id="home" class="body">
    ...
    <section id="main-slider">
        <div class="owl-carousel">
            <div class="item" style="background-image: url(images/Banner-1.jpg);">
                <div class="slider-inner">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h2><span class="Span">Cadastre-se</span> Fique por dentro das novidades</h2>
                                    <p> </p>
                                    <a href="Cadastro.php" class="teste">Cadastrar</a>
                                </div>
                            </div>
                        </div>
                    </div>
             ...
             <div class="item" style="background-image: url(images/Banner-3.jpg);">
                <div class="slider-inner">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h2><span class="Span">Cadastre-se</span>
									Fique por dentro das novidades</h2>
                                    <p></p>
									<p class="teste"><a class="teste" href="Cadastro.php">Cadastrar</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
	...
	<div class="tiktutz">		
		<div class="tikimg">
			...
			<div class="tik">
				...
				<h2>O que é o TikTutz?</h2><br>
				<p>Uma Plataforma Online que Busca levar ao Nosso Publico
					O<br> melhor conteudo quando se fala em entreterimento</p>
				<a class="botaoroxo" href="#">Ler mais</a>
